...
A Kirigami-based developer utility suite, providing a set of handy tools in a potentially cross-platform interface, inspired by [IT-Tools](https://github.com/CorentinTh/it-tools).
